...
//모듈은 사실 상 파일이다(함수 단위로 등록하기도 한다!..)! 아래의 두개의 변수는 ./routes/index.js파일을 의미한다
//컨트롤러 같은 존재
...
//자동으로 응답을 처리한다..(정적 자원이란 서버에서 실행되지 않는 모든것: html,css,js,image....)
app.use(express.static(path.join(__dirname, 'public'))); //정적 자원의 위치 (스프링으로 말하면  resoureces)
